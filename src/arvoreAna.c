/* 
    Podemos usar esse arquivo para rodá-lo individualmente,
    apenas para ir testando se a implementação da árvore está correta,
    sem precisar rodar todo o resto do trabalho junto.
    Comandos:
    gcc arvoreAna.c -o a
    ./a 
*/
    ...
    do {
        ...
        switch(op) {
            ...
            case 3:
                ...
                scanf("%d", &valor);
                printf("\nResultado da busca (0 = não encontrado e 1 = encontrado): %d", buscar(raiz, valor));
                break;
            case 4:
